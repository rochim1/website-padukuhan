...
return [
    'name' => env('VILLAGE_NAME', 'Padukuhan Prujakan'),
    'location' => 'Kalurahan Sinduharjo, Kapanewon Ngaglik, Kabupaten Sleman',
    'province' => 'Daerah Istimewa Yogyakarta',
    'address' => 'Padukuhan Prujakan, Sinduharjo, Ngaglik, Sleman 55581',
    'email' => 'sapa@prujakan.id',
    ...
    'potentials' => [
        ...
        ['slug'=>'jelajah-sungai','title' => 'Jelajah Sungai', 'category' => 'Wisata', 'icon' => 'ri-route-line', 'text' => 'Rute jalan kaki menyusuri bentang alam, persawahan, dan kehidupan sehari-hari warga.','owner'=>'Pokdarwis Prujakan','contact'=>'0812-3333-4455','image'=>'https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=1200&q=82'],
    ],
    'tourism' => [
        ['slug'=>'jelajah-sungai','title'=>'Jelajah Sungai','tagline'=>'Wisata Alam & Kehidupan Warga','description'=>'Rute jalan kaki menyusuri bentang alam, persawahan, aliran sungai, dan kehidupan sehari-hari warga.','image'=>'https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=1600&q=86','gallery'=>['https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=1200&q=84','https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1200&q=84'],'address'=>'Padukuhan Prujakan, Sinduharjo, Ngaglik, Sleman','contact'=>'6281233334455','opening_hours'=>'Setiap hari, 07.00–17.00','ticket_price'=>'Donasi sukarela','facilities'=>['Area parkir','Pemandu lokal','Warung warga'],'activities'=>['Jelajah sungai','Trekking persawahan','Fotografi alam'],'tourism_services'=>['Pemandu trekking — hubungi pengelola'],'latitude'=>-7.7257,'longitude'=>110.3995,'booking_url'=>'','booking_instructions'=>'1. Hubungi pengelola melalui WhatsApp','seo_description'=>'Jelajahi alam dan kehidupan warga di Padukuhan Prujakan, Sinduharjo, Ngaglik.'],
    ],
    'sponsors' => [
        ['slug'=>'koperasi-sejahtera','title'=>'Koperasi Sejahtera','tagline'=>'Mitra Ekonomi Warga','description'=>'Mendukung penguatan usaha warga, pelatihan pemasaran, dan kegiatan sosial Padukuhan Prujakan.','image'=>'https://placehold.co/600x300/ffffff/075f4c?text=Koperasi+Sejahtera','gallery'=>[],'contact'=>'info@koperasisejahtera.id','website_url'=>'https://example.com','seo_description'=>'Kolaborasi Koperasi Sejahtera bersama warga Padukuhan Prujakan.'],
    ],
    'services'=>[
    ...
    'facilities'=>[
        ['name'=>'Balai Warga','type'=>'Pelayanan','icon'=>'ri-government-line','address'=>'Pusat Padukuhan Prujakan'],['name'=>'Posyandu Melati','type'=>'Kesehatan','icon'=>'ri-heart-pulse-line','address'=>'Padukuhan Prujakan'],['name'=>'Lapangan Prujakan','type'=>'Olahraga','icon'=>'ri-football-line','address'=>'Padukuhan Prujakan'],['name'=>'Mushola Al-Ikhlas','type'=>'Ibadah','icon'=>'ri-moon-line','address'=>'Padukuhan Prujakan'],['name'=>'Rumah Pilah Sampah','type'=>'Lingkungan','icon'=>'ri-recycle-line','address'=>'Padukuhan Prujakan'],['name'=>'Taman Baca Warga','type'=>'Pendidikan','icon'=>'ri-book-open-line','address'=>'Kompleks Balai Warga Prujakan'],
    ],
    'gallery'=>[
